        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 relative">
            <div className="grid grid-cols-2 gap-4">
              <img src="/images/studio-exterior.png" alt="Garden Office Exterior" className="rounded-2xl shadow-lg mt-8 w-full object-cover h-64 md:h-80" />
              <img src="/images/studio-interior.png" alt="Garden Studio Interior" className="rounded-2xl shadow-lg w-full object-cover h-64 md:h-80" />
            </div>
            {/* Decorative element */}
