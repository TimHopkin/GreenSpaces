...
const Gallery: React.FC = () => {
  const images = [
    { src: "/images/studio-exterior.png", label: "Garden Studio" },
    { src: "/images/hero-garden-studio.png", label: "Bespoke Kitchen" },
    { src: "/images/studio-interior.png", label: "Cedar Decking" },
    { src: "/images/gallery-oak-garage.png", label: "Oak Frame Garage" },
    { src: "/images/gallery-wardrobes.png", label: "Custom Wardrobes" },
    { src: "/images/gallery-fencing.png", label: "Timber Fencing" },
  ];
